"""
=============================================================================
Lumively — FastAPI Application Entry Point
=============================================================================
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    logger.info("=" * 60)
    logger.info("Lumively Autonomous E-Commerce Platform — Starting Up")
    ...
    logger.info("=" * 60)
    logger.info("Lumively is ready to serve requests")
    logger.info("=" * 60)

    yield  # --- Application is running ---

    # --- Shutdown: Clean up resources in reverse order ---
    logger.info("Shutting down Lumively...")
    ...
    logger.info("Lumively shutdown complete.")
...
# =============================================================================
app = FastAPI(
    title="Lumively Admin & Automation",
...
# =============================================================================
from routers import admin, api, auth, marketing  # noqa: E402
