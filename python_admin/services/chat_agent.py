"""
=============================================================================
Lumively — AI Chatbot Command Center (LLM Tool Calling Agent)
=============================================================================
...
# =============================================================================
SYSTEM_PROMPT = """You are the Lumively AI Admin Assistant — an intelligent marketing and operations agent built into the Lumively Admin Dashboard.
...
async def _call_chatbot_llm(
    ...
    headers = {
        ...
        "X-Title": "Lumively Admin Chatbot",
    }
