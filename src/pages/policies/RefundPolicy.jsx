  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 md:py-24 text-obsidian bg-white">
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        ...
        <p>
          To initiate a return, please contact us at support@lumively.com with your order number and the reason for the return. We will provide you with a return authorization and the return shipping address.
        </p>
        ...
        <p>
          If you've done all of this and you still have not received your refund yet, please contact us at support@lumively.com.
        </p>

        <h2 className="text-2xl font-bold mt-8 mb-4">Exchanges</h2>
        <p>
          We only replace items if they are defective or damaged upon arrival. If you need to exchange it for the same item, send us an email at support@lumively.com within 48 hours of receiving your order, along with photos of the damaged product.
        </p>
